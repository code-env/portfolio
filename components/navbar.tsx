...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={cn(
        "fixed px-4 lg:px-0 right-10 left-10 lg:left-0 lg:right-0 top-3 lg:max-w-5xl lg:w-full mx-auto h-14 border-b border-border backdrop-blur bg-background/50 justify-between flex items-center  transition-all duration-200 text-neutral-700  z-[10000000000]",
        {
