      ...
      >
        <div tw="rounded-xl border-2 border-stone-700 w-full h-full p-4 flex bg-stone-800 shadow-lg">
          <img
            width="375"
            height="562"
            src={createImageUrl(writing.image?.url ?? "", 375, 562)}
          ...
          <div tw="flex flex-col px-6 w-[740px] h-full justify-between">
            <div tw="flex flex-col">
              <span
                tw={clsx("font-bold text-stone-50 mb-6", {
                  "text-7xl": writing.title.length < 40,
                  "text-6xl": writing.title.length >= 40,
                })}
                style={{
                  fontFamily: '"Raleway"',
                }}
              ...
              <span tw="text-5xl text-stone-300">{writing.description}</span>
            </div>
            <div tw="flex justify-between items-end w-full text-stone-400 text-xl">
              ...
              <span>
                {writing.date.substring(0, writing.date.indexOf("T"))}
              </span>
            </div>
          </div>
          <div
